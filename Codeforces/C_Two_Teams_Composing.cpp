...
void solve() {
    ...
    // while calculating distinct , max term also included
    // when distinct == mx : then the max elemt is ditributed to each group 
    // Ex : 1234444 : 
    // distinct  4 --> 1 2 3 4
    // MAx : 4 4 4 4
    // 123 444  : one 4 not included
    cout << min(distinct, mx) - (distinct == mx) << endl;
